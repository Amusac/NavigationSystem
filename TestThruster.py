...
class TestThruster:
    ...
    def __init__(self, pin_servo, pin_thruster):
        ...
        self.pi.get_PWM_frequency(self.pin_thruster)
        self.pi.get_servo_pulsewidth(self.pin_thruster)
        return
...
if __name__ == "__main__":
    ...
    try:
        ...
        if inp == "":
            time.sleep(3)
        print("PWM_width", sample.get_servo_pulsewidth(params.pin_thruster_out))
        print("frequency:", sample.get_frquency(params.pin_thruster_out))
        print('"stop"')
        print('"u" to up speed')
